...
<div class="container mainContent white">
    <?php if (!$invalid) { ?>
        ...
        echo '<div id="login_section" class="span6">' . "\n";
        echo "<article>\n";
        ...
        <article>
            ...
            <form id="register" name="<?php $basename; ?>" method="post" autocomplete="off">
                <fieldset>
                    ...
                    <input id="email" type="email" name="email" value="<?php echo(isset($validate->valid['validEmail']) && $validate->valid['validEmail']) ? $validate->data['email'] : NULL; ?>" tabindex="7">
                    <label for="verify_email">verify email</label>
                    <input id="verify_email" type="email" name="verify_email" value="<?php echo(isset($validate->valid['verifyEmail']) && $validate->valid['verifyEmail']) ? $validate->data['verify_email'] : NULL; ?>" tabindex="8">
